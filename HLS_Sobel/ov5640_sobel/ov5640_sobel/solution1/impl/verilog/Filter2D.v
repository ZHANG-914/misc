...
reg   [0:0] exitcond460_i_reg_1392;
reg   [0:0] or_cond_i_i_reg_1401;
reg   [0:0] icmp_reg_1357;
reg   [0:0] tmp_5_reg_1348;
reg    p_dst_data_stream_V_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] or_cond_i_reg_1437;
reg   [0:0] or_cond_i_reg_1437_pp0_iter1_reg;
reg   [31:0] t_V_2_reg_277;
wire   [31:0] tmp_s_fu_288_p2;
reg   [31:0] tmp_s_reg_1305;
wire   [31:0] tmp_1_fu_294_p2;
reg   [31:0] tmp_1_reg_1310;
wire   [31:0] p_neg465_i_fu_300_p2;
reg   [31:0] p_neg465_i_reg_1315;
...
reg   [0:0] brmerge_reg_1405;
reg   [10:0] k_buf_0_val_3_addr_reg_1412;
wire   [1:0] tmp_37_fu_796_p1;
reg   [1:0] tmp_37_reg_1418;
reg   [10:0] k_buf_0_val_4_addr_reg_1425;
reg   [10:0] k_buf_0_val_5_addr_reg_1431;
wire   [0:0] or_cond_i_fu_800_p2;
wire   [7:0] p_Val2_3_fu_1166_p3;
reg   [7:0] p_Val2_3_reg_1441;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_condition_pp0_exit_iter1_state4) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((exitcond461_i_fu_336_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond460_i_fu_655_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        k_buf_0_val_3_addr_reg_1412 <= tmp_25_fu_789_p1;
        k_buf_0_val_4_addr_reg_1425 <= tmp_25_fu_789_p1;
        k_buf_0_val_5_addr_reg_1431 <= tmp_25_fu_789_p1;
...
always @ (posedge ap_clk) begin
    if (((or_cond_i_reg_1437 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        tmp_4_reg_1327[31 : 1] <= tmp_4_fu_318_p2[31 : 1];
        tmp_8_reg_1334[31 : 1] <= tmp_8_fu_330_p2[31 : 1];
        tmp_s_reg_1305 <= tmp_s_fu_288_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond460_i_reg_1392 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((exitcond461_i_fu_336_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_12_reg_1362 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (icmp_reg_1357 == 1'd0) & (exitcond460_i_reg_1392 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if ((((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_114_1_reg_1366 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (icmp_reg_1357 == 1'd0) & (exitcond460_i_reg_1392 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_896)) begin
        if (((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1))) begin
            k_buf_0_val_4_d1 = k_buf_0_val_3_q0;
        end else if (((tmp_114_1_reg_1366 == 1'd1) & (icmp_reg_1357 == 1'd0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_896)) begin
        ...
        end else if (((tmp_12_reg_1362 == 1'd1) & (icmp_reg_1357 == 1'd0))) begin
...
always @ (*) begin
    if (((or_cond_i_reg_1437_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((or_cond_i_reg_1437_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((or_cond_i_i_reg_1401 == 1'd1) & (icmp_reg_1357 == 1'd0) & (exitcond460_i_reg_1392 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((or_cond_i_reg_1437_pp0_iter1_reg == 1'd1) & (p_dst_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((p_src_data_stream_V_empty_n == 1'b0) & (ap_predicate_op166_read_state4 == 1'b1)) | ((p_src_data_stream_V_empty_n == 1'b0) & (ap_predicate_op155_read_state4 == 1'b1)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((or_cond_i_reg_1437_pp0_iter1_reg == 1'd1) & (p_dst_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((p_src_data_stream_V_empty_n == 1'b0) & (ap_predicate_op166_read_state4 == 1'b1)) | ((p_src_data_stream_V_empty_n == 1'b0) & (ap_predicate_op155_read_state4 == 1'b1)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((or_cond_i_reg_1437_pp0_iter1_reg == 1'd1) & (p_dst_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((p_src_data_stream_V_empty_n == 1'b0) & (ap_predicate_op166_read_state4 == 1'b1)) | ((p_src_data_stream_V_empty_n == 1'b0) & (ap_predicate_op155_read_state4 == 1'b1)))));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter2 = ((or_cond_i_reg_1437_pp0_iter1_reg == 1'd1) & (p_dst_data_stream_V_full_n == 1'b0));
end

always @ (*) begin
    ap_condition_896 = ((or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

always @ (*) begin
    ap_enable_operation_119 = (exitcond460_i_fu_655_p2 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_122 = (exitcond460_i_fu_655_p2 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_124 = (exitcond460_i_fu_655_p2 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_146 = (exitcond460_i_reg_1392 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_149 = (exitcond460_i_reg_1392 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_152 = (exitcond460_i_reg_1392 == 1'd0);
end
...
always @ (*) begin
    ap_predicate_op155_read_state4 = ((or_cond_i_i_reg_1401 == 1'd1) & (icmp_reg_1357 == 1'd0) & (exitcond460_i_reg_1392 == 1'd0));
end

always @ (*) begin
    ap_predicate_op156_store_state4 = ((tmp_12_reg_1362 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (icmp_reg_1357 == 1'd0) & (exitcond460_i_reg_1392 == 1'd0));
end

always @ (*) begin
    ap_predicate_op158_store_state4 = ((tmp_114_1_reg_1366 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (icmp_reg_1357 == 1'd0) & (exitcond460_i_reg_1392 == 1'd0));
end

always @ (*) begin
    ap_predicate_op160_store_state4 = ((tmp_12_reg_1362 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (icmp_reg_1357 == 1'd0) & (exitcond460_i_reg_1392 == 1'd0));
end

always @ (*) begin
    ap_predicate_op164_store_state4 = ((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0));
end

always @ (*) begin
    ap_predicate_op165_store_state4 = ((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0));
end

always @ (*) begin
    ap_predicate_op166_read_state4 = ((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0));
end

always @ (*) begin
    ap_predicate_op167_store_state4 = ((tmp_5_reg_1348 == 1'd1) & (icmp_reg_1357 == 1'd1) & (or_cond_i_i_reg_1401 == 1'd1) & (exitcond460_i_reg_1392 == 1'd0));
end

assign brmerge_fu_784_p2 = (tmp_9_fu_702_p2 | tmp_70_0_not_reg_1352);

assign col_assign_1_fu_779_p2 = (tmp_2_reg_1322 - x_fu_771_p3);

assign col_buf_0_val_0_0_fu_834_p3 = ((brmerge_reg_1405[0:0] === 1'b1) ? k_buf_0_val_3_q0 : tmp_26_fu_823_p5);

assign col_buf_0_val_1_0_fu_852_p3 = ((brmerge_reg_1405[0:0] === 1'b1) ? k_buf_0_val_4_q0 : tmp_27_fu_841_p5);

assign col_buf_0_val_2_0_fu_870_p3 = ((brmerge_reg_1405[0:0] === 1'b1) ? k_buf_0_val_5_q0 : tmp_28_fu_859_p5);

assign exitcond460_i_fu_655_p2 = ((t_V_2_reg_277 == tmp_s_reg_1305) ? 1'b1 : 1'b0);

assign exitcond461_i_fu_336_p2 = ((t_V_reg_266 == tmp_1_reg_1310) ? 1'b1 : 1'b0);
...
assign k_buf_0_val_3_address1 = k_buf_0_val_3_addr_reg_1412;

assign k_buf_0_val_4_address0 = tmp_25_fu_789_p1;

assign k_buf_0_val_4_address1 = k_buf_0_val_4_addr_reg_1425;

assign k_buf_0_val_5_address0 = tmp_25_fu_789_p1;

assign k_buf_0_val_5_address1 = k_buf_0_val_5_addr_reg_1431;
...
assign or_cond_i_fu_800_p2 = (icmp_reg_1357 & icmp1_fu_676_p2);
...
assign p_Val2_3_fu_1166_p3 = ((tmp_1_i_i_fu_1160_p2[0:0] === 1'b1) ? p_mux_i_i_cast_fu_1152_p3 : p_Val2_1_fu_1118_p2);

assign p_Val2_s_fu_1086_p2 = (tmp21_fu_1064_p2 + tmp22_fu_1080_p2);

assign p_assign_1_fu_721_p2 = (32'd1 - t_V_2_reg_277);

assign p_assign_2_fu_740_p2 = (tmp_8_reg_1334 - p_p2_i_i_fu_727_p3);
...
assign p_assign_8_1_fu_512_p2 = (tmp_4_reg_1327 - p_p2_i497_i_1_fu_499_p3);

assign p_assign_8_2_fu_575_p2 = (tmp_4_reg_1327 - p_p2_i497_i_2_fu_562_p3);

assign p_assign_8_fu_449_p2 = (tmp_4_reg_1327 - p_p2_i497_i_fu_436_p3);

assign p_dst_data_stream_V_din = p_Val2_3_reg_1441;
...
assign row_assign_9_1_fu_621_p2 = (p_neg465_i_reg_1315 - y_1_fu_613_p3);

assign row_assign_9_2_fu_646_p2 = (p_neg465_i_reg_1315 - y_2_fu_638_p3);

assign row_assign_9_fu_596_p2 = (p_neg465_i_reg_1315 - y_fu_588_p3);
...
assign src_kernel_win_0_va_6_fu_924_p3 = ((tmp_13_reg_1370[0:0] === 1'b1) ? tmp_29_fu_913_p5 : col_buf_0_val_0_0_fu_834_p3);

assign src_kernel_win_0_va_7_fu_942_p3 = ((tmp_13_reg_1370[0:0] === 1'b1) ? tmp_30_fu_931_p5 : col_buf_0_val_1_0_fu_852_p3);

assign src_kernel_win_0_va_8_fu_960_p3 = ((tmp_13_reg_1370[0:0] === 1'b1) ? tmp_31_fu_949_p5 : col_buf_0_val_2_0_fu_870_p3);
...
always @ (posedge ap_clk) begin
    tmp_4_reg_1327[0] <= 1'b0;
    tmp_8_reg_1334[0] <= 1'b0;
end
